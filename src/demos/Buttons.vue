    ...
    <div class="page-content">
      ...
      <div class='content-padded'>
        ...
        <div class="content-block">
          <p><a href="javascript:;" class="button">Usual Button 1</a></p>
          <p><a href="javascript:;" class="button button-success">success button</a></p>
        ...
        <div class="content-block">
          <p><a href="javascript:;" class="button button-round">Round Button 1</a></p>
        </div>
        <div class="content-block">
        ...
        <div class="content-block-title">Fill Button</div>
        <div class="content-block">
          <p><a href="javascript:;" class="button button-fill">Fill Button </a></p>
          <p><a href="javascript:;" class="button button-fill button-success">Fill Button </a></p>
          <p><a href="javascript:;" class="button button-fill button-danger">Fill Button </a></p>
          <p><a href="javascript:;" class="button button-fill button-warning">Fill Button </a></p>
        </div>
        <div class="content-block-title">List Button</div>
        <div class="list-block">
          <ul>
            <li><a href="javascript:;" class="item-link list-button">List Button 1</a></li>
            <li><a href="javascript:;" class="item-link list-button">List Button 2</a></li>
        ...
        <div class="content-block">
          <div class="row">
            ...
            <div class="col-50"><a href="javascript:;" class="button button-big button-fill button-success">Submit</a></div>
          </div>
        </div>
      </div>
    </div>
